...
// Start index for every month in array
const int startIndex[]={0,31,60,91,121,152,182,213,244,274,305,335};

// Saint/Birthday/whatever you want list
// 1 anniversary for each day. Longest sentence is 19 chars long
const char dp[366][20]={
  // JANUARY *******************************************************************************
  ...
  "San Fedele         ", // 24
  "S. Marco Evangel.  ", // 25 - In Italy it's "Anniversario della liberazione"
  "S. Marcellino      ", // 26
  "Santa Zita         ", // 27
  "S. Pietro, Valeria ", // 28
  "Santa Antonella    ", // 29
  ...
  "S.Guglielmo,Febroni", // 25
  "San Josemaria      ", // 26
  "S. Cirillo di Ales.", // 27
  "S. Ireneo di Lione ", // 28
  "S. Pietro e Paolo  ", // 29
  ...
  "S. Aronne, Ester   ", // 1
  "Sant' Ottone       ", // 2
  "S. Tommaso apostolo", // 3
  "S. Elisabetta      ", // 4
  "S.Antonio Maria Za.", // 5
  ...
  "S. Angeli custodi  ", // 2
  "Sant' Edmondo      ", // 3
  "S.Francesco d'Assis", // 4
  "S. Placido,Faustina", // 5
  "San Bruno          ", // 6
  "B.V.M. del Rosario ", // 7
  "Santa Pelagia      ", // 8
  "San Dionigi        ", // 9
